...
Do not assume extension-based browser tooling will exist in detached Claude worker sessions (the tmux pane is not an attached interactive browser context). Playwright is a better default because it is explicit, scriptable, and portable.
