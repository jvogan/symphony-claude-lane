...
A worker session that exited cleanly (sentinel `status='completed'`, tmux session torn down) is not the same as verified tracker closeout. Launchers or status tools should record:
